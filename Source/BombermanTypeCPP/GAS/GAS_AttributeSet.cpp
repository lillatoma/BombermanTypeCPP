...
void UGAS_AttributeSet::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
  ...
  DOREPLIFETIME_CONDITION_NOTIFY(UGAS_AttributeSet, BombCount, COND_None, REPNOTIFY_Always);
  ...
  DOREPLIFETIME_CONDITION_NOTIFY(UGAS_AttributeSet, BombRange, COND_None, REPNOTIFY_Always);

}

void UGAS_AttributeSet::OnRep_BombCount(const FGameplayAttributeData& OldBombCount)
{
	GAMEPLAYATTRIBUTE_REPNOTIFY(UGAS_AttributeSet, BombCount, OldBombCount);
}
...
void UGAS_AttributeSet::OnRep_BombRange(const FGameplayAttributeData& OldBombRange)
{
	GAMEPLAYATTRIBUTE_REPNOTIFY(UGAS_AttributeSet, BombRange, OldBombRange);
}